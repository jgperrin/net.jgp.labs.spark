...
public abstract class RecordGeneratorUtils {
  ...
  private static String[] fnames = { "John", "Kevin", "Lydia", "Nathan", "Jane",
      "Liz", "Sam", "Ruby", "Peter",
      "Mahendra", "Noah", "Noemie", "Fred", "Anupam", "Stephanie", "Ken", "Sam",
      "Murthy", "Jonathan", "Jean",
      "Georges", "Oliver" };
  private static String[] lnames = { "Smith", "Mills", "Perrin", "Foster",
      "Kumar", "Jones", "Tutt", "Main", "Haque",
  ...
  private static String[] nouns = { "Life", "Trip", "Experience", "Work", "Job",
      "Beach" };
  private static int[] daysInMonth = { 31, 28, 31, 30, 31, 30, 31, 31, 30, 31,
      30, 31 };
