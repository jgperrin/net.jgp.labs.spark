...
//                .getOrCreate();
        ...
        spark.sparkContext().hadoopConfiguration().set("fs.s3a.access.key",
                "AKIAIXXFAH5Q2HFLVBJA");
        spark.sparkContext().hadoopConfiguration().set("fs.s3a.secret.key",
                "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");
        String bucket = "lumeris.data.platform.nonprod";
        String key = "PanamaCanal/dev/data/claim/EHIODS_0_1000_CLAIM";
