...
public class CustomDataSourceToDataset {
    private static transient Logger log = LoggerFactory.getLogger(CustomDataSourceToDataset.class);
    ...
    private void start() {
        SparkSession spark = SparkSession.builder().appName("Custom data set to Dataset")
