package net.jgp.labs.spark.l250_map.l101_pi;
 ...
 * @author jgp
 */
public class PiComputeLambdaWithClassApp implements Serializable {
  ...
  public static void main(String[] args) {
    PiComputeLambdaWithClassApp app = new PiComputeLambdaWithClassApp();
    app.start(10);
  }
